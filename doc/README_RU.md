...
* **Просто:** одна команда — и у вас своя карта.
* **Полезно:** локальная история фона — навсегда у вас.
...
* **Что и откуда она читает?**
  ...
  * Из файлов форматов `.kml`, `.kmz`, `.json`, `.rctrk` (AtomFast, RadiaCode и другие).
...
3. Отметьтесь в Issue репозитория проекта или в чате сообщества.
